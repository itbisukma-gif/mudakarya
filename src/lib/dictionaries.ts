...
const id = {
    ...
    footer: {
      ...
      copyright: (year: number) => `© ${year} MudaKarya CarRent. Hak cipta dilindungi undang-undang.`,
      navLinks: [
        { href: "/", label: "Home" },
    ...
    testimonials: {
        ...
        rented: "Menyewa",
        galleryAlt: "Galeri pelanggan MudaKarya CarRent",
        galleryHover: "Momen bersama MudaKarya CarRent",
    },
    contact: {
...
const en: typeof id = {
    ...
    footer: {
      ...
      copyright: (year: number) => `© ${year} MudaKarya CarRent. All rights reserved.`,
      navLinks: [
        { href: "/", label: "Home" },
    ...
    testimonials: {
        ...
        rented: "Rented",
        galleryAlt: "MudaKarya CarRent customer gallery",
        galleryHover: "Moments with MudaKarya CarRent",
    },
    contact: {
